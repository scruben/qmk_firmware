...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LT(_LOWER,KC_TAB),LSFT_T(KC_A),LALT_T(KC_S),LGUI_T(KC_D), LCTL_T(KC_F), LT(_RAISE,KC_G),          LT(_RAISE,KC_H),RCTL_T(KC_J), RGUI_T(KC_K), LALT_T(KC_L),RSFT_T(KC_SCLN), LT(_LOWER,KC_QUOT), KC_BSLS,
