...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LSFT   , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                                          KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_LSFT, KC_LSFT,
                        KC_LEFT, KC_RIGHT,                                                                                KC_UP  , KC_DOWN,
                                        KC_BTN1, MO(_RAISE),                                                   KC_BSPC ,
                                                            KC_LGUI   , KC_LCTL   ,   KC_DEL ,          KC_SPC ,
    ...
    KC_CAPS   , KC_A   , KC_S   , KC_D   , KC_LPRN, KC_RPRN,                                          KC_H   , KC_4   , KC_5   , KC_6   , KC_0   , KC_QUOT, KC_ENT ,
