...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LSFT   , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                                          KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_LSFT, KC_LSFT,
                        KC_LEFT, KC_RIGHT,                                                                                KC_UP  , KC_DOWN,
                                        KC_BTN1, MO(_RAISE),                                                   KC_SPC ,
                                                            KC_LGUI   , KC_LALT   ,   KC_DEL ,          KC_ENT ,
                                                            KC_LCTL   , KC_ESC    ,            KC_BSPC
    ),

    [_LOWER] = LAYOUT_5x6(
    KC_TILD   , KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5   ,                                         KC_F6  , KC_F7  , KC_F8  , KC_F9  , KC_F10 , KC_F11, KC_F12 ,
    KC_TAB    , KC_Q   , KC_MNXT, KC_E   , KC_R   , KC_T   ,                                          KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_LBRC, KC_RBRC,
    KC_ESC    , KC_HOME, KC_MPLY, KC_BSPC, KC_DEL , KC_G   ,                                          KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_END, KC_QUOT, KC_ENT ,
    KC_CAPS   , KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                                          KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_LSFT, KC_LSFT,
                        KC_LEFT, KC_RIGHT,                                                                                KC_UP  , KC_DOWN,
                                        KC_BTN1, TD(RAI_TM),                                                   KC_ENT,
    ...
    KC_TAB    , KC_Q   , KC_W   , KC_E   , KC_R   , KC_T   ,                                          KC_Y   , KC_1   , KC_2   , KC_3   , KC_P   , KC_LBRC, KC_RBRC,
    KC_ESC    , KC_A   , KC_S   , KC_D   , KC_F   , KC_G   ,                                          KC_H   , KC_4   , KC_5   , KC_6   , KC_0, KC_QUOT, KC_ENT ,
    TD(SFT_TM), KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   ,                                          KC_N   , KC_7   , KC_8   , KC_9   , KC_SLSH, KC_LSFT, KC_LSFT,
                        KC_LEFT, KC_RIGHT,                                                                                KC_UP  , KC_DOWN,
                                        KC_BTN1, TD(RAI_TM),                                                   KC_SPC ,
                                                            TD(GUI_TM), TD(ALT_TM),   KC_DEL ,          KC_ENT ,
                                                            TD(CTL_TM), TD(LOW_TM),            KC_BSPC
    )
};
